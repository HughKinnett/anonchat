...
assert.match(css, /\.spotify-playlist-name-mask\{[^}]*top:6[0-9]px[^}]*left:1(?:3[468]|4[0-9])px[^}]*right:/,
  "privacy mask must sit below the song title on Spotify's playlist-name row");
