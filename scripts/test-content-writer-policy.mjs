...
assert.deepEqual(buildOriginalPost({
  ...
  type: "original", authorId: "writer", username: "writer_name", content: "hello", imageData: "", category: "Post", options: [], expiresAt: null, moderationState: "visible", createdAt: timestamp
});
assert.deepEqual(buildRepost({
  ...
  type: "repost", authorId: "writer", username: "writer_name", sourceCollection: "posts", originalPostId: "source", originalAuthorId: "author", originalUsername: "author_name", content: "shared", imageData: "", moderationState: "visible", createdAt: timestamp
});
