...
const openRoom=async roomId=>{
  ...
  const room=roomSnap.data();$("active-premium-room").textContent=room.name;$("active-premium-topic").textContent=room.topic||"Private Premium room";$("premium-message-form").hidden=false;
