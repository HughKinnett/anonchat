...
export const cleanupQueries = (targetUid) => Object.freeze([
  ...
  field("message-requests-from-target", "messageRequests", "fromId", targetUid, { cascade: "document" }),
  field("message-requests-to-target", "messageRequests", "toId", targetUid, { cascade: "document" }),
  ...
  field("owned-premium-rooms", "premiumRooms", "ownerId", targetUid, { cascade: "document" }),
  field("premium-room-memberships", "premiumRoomMembers", "uid", targetUid),
  field("premium-room-messages", "messages", "senderId", targetUid, { group: true }),
  ...
  direct("premium-access", "premiumAccess", targetUid),
  direct("premium-settings", "premiumSettings", targetUid),
  direct("e2ee-public-key", "e2eePublicKeys", targetUid),
  direct("e2ee-private-key", "e2eePrivateKeys", targetUid),
  field("e2ee-room-keys-for-target", "e2eeRoomKeyEnvelopes", "recipientUid", targetUid),
  field("e2ee-room-keys-from-target", "e2eeRoomKeyEnvelopes", "senderUid", targetUid),
  direct("stripe-customer", "customers", targetUid, { cascade: "document" }),
